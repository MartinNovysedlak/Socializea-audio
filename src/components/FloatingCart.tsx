              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-7 bg-black/20 border border-white/10 rounded-2xl p-4 md:p-6 lg:p-8">
                  <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                    ...
                    <div className="grid grid-cols<dyad-problem-report summary="121 problems">
<problem file="src/components/FloatingCart.tsx" line="3" column="1" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="3" column="5" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="4" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="6" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="32" code="1005">',' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="52" code="1005">',' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="56" code="1005">',' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="73" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="79" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="90" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="5" column="4" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="5" column="35" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="1" code="1435">Unknown keyword or identifier. Did you mean 'let'?</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="5" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="8" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="12" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="16" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="22" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="26" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="33" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="55" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="85" code="1002">Unterminated string literal.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="7" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="30" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="34" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="38" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="41" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="45" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="64" code="1003">Identifier expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="71" code="1005">',' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="10" column="3" code="1144">'{' or ';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="11" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="47" code="1109">Expression expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="52" code="1005">'(' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="60" code="1005">')' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="7" code="1443">Module declaration names may only use ' or " quoted strings.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="33" code="1127">Invalid character.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="33" code="1128">Declaration or statement expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="35" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="48" code="1005">'(' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="7" code="1005">')' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="23" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="27" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="31" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="34" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="38" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="60" code="1005">';' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="1" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="6" code="1228">A type predicate is only allowed in return type position for functions and methods.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="9" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="22" code="1443">Module declaration names may only use ' or " quoted strings.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="42" code="1005">'(' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="46" code="1005">')' expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="50" code="1434">Unexpected keyword or identifier.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="66" code="1109">Expression expected.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="47" code="1101">'with' statements are not allowed in strict mode.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="43" code="1101">'with' statements are not allowed in strict mode.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="37" code="1101">'with' statements are not allowed in strict mode.</problem>
<problem file="src/components/FloatingCart.tsx" line="3" column="1" code="2304">Cannot find name 'The'.</problem>
<problem file="src/components/FloatingCart.tsx" line="3" column="5" code="2304">Cannot find name 'user'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="4" code="2304">Cannot find name 'A'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="6" code="2304">Cannot find name 'success'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="14" code="2304">Cannot find name 'popup'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="21" code="2304">Cannot find name 'same'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="29" code="2304">Cannot find name 'in'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="32" code="2304">Cannot find name 'PackageDetailDialog'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="52" code="2304">Cannot find name 'and'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="56" code="2304">Cannot find name 'EquipmentDetail'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="73" code="2304">Cannot find name 'after'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="79" code="2304">Cannot find name 'submitting'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="90" code="2304">Cannot find name 'a'.</problem>
<problem file="src/components/FloatingCart.tsx" line="4" column="92" code="2304">Cannot find name 'reservation'.</problem>
<problem file="src/components/FloatingCart.tsx" line="5" column="35" code="2304">Cannot find name 'and'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="1" code="2304">Cannot find name 'Let'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="5" code="2304">Cannot find name 'me'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="8" code="2304">Cannot find name 'add'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="12" code="2304">Cannot find name 'the'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="16" code="2304">Cannot find name 'state'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="22" code="2304">Cannot find name 'and'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="26" code="2304">Cannot find name 'dialog'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="33" code="2304">Cannot find name 'to'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="36" code="2304">Cannot find name 'FloatingCart'.</problem>
<problem file="src/components/FloatingCart.tsx" line="7" column="55" code="2362">The left-hand side of an arithmetic operation must be of type 'any', 'number', 'bigint' or an enum type.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="3" code="2304">Cannot find name 'Add'.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="7" code="2304">Cannot find name 'state'.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="13" code="2304">Cannot find name 'variables'.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="25" code="2304">Cannot find name 'near'.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="30" code="2304">Cannot find name 'the'.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="38" code="2304">Cannot find name 'of'.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="41" code="2304">Cannot find name 'the'.</problem>
<problem file="src/components/FloatingCart.tsx" line="9" column="45" code="2304">Cannot find name 'component'.</problem>
<problem file="src/components/FloatingCart.tsx" line="10" column="3" code="2349">This expression is not callable.
  Type 'String' has no call signatures.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="3" code="2304">Cannot find name 'Replace'.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="11" code="2304">Cannot find name 'the'.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="15" code="2304">Cannot find name 'toast'.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="32" code="2304">Cannot find name 'handleSubmit'.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="32" code="2322">Type 'number' is not assignable to type 'object'.</problem>
<problem file="src/components/FloatingCart.tsx" line="14" column="52" code="2304">Cannot find name 'showing'.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="1" code="2304">Cannot find name 'After'.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="35" code="2304">Cannot find name 'replace'.</problem>
<problem file="src/components/FloatingCart.tsx" line="15" column="48" code="2304">Cannot find name 'setting'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="3" code="2304">Cannot find name 'Add'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="11" code="2304">Cannot find name 'Dialog'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="20" code="2304">Cannot find name 'at'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="23" code="2304">Cannot find name 'the'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="27" code="2304">Cannot find name 'end'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="31" code="2304">Cannot find name 'of'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="34" code="2304">Cannot find name 'the'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="38" code="2304">Cannot find name 'component'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="48" code="2304">Cannot find name 'JSX'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="48" code="2695">Left side of comma operator is unused and has no side effects.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="53" code="2304">Cannot find name 'before'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="60" code="2304">Cannot find name 'the'.</problem>
<problem file="src/components/FloatingCart.tsx" line="17" column="64" code="2304">Cannot find name 'closing'.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="1" code="2304">Cannot find name 'Here'.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="6" code="2304">Cannot find name 'is'.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="9" code="2304">Cannot find name 'the'.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="13" code="2304">Cannot find name 'complete'.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="42" code="2304">Cannot find name 'all'.</problem>
<problem file="src/components/FloatingCart.tsx" line="19" column="50" code="2304">Cannot find name 'changes'.</problem>
<problem file="src/App.tsx" line="15" column="8" code="1192">Module '"C:/Users/mnovysedlak/dyad-apps/audio-rent-admin/src/components/FloatingCart"' has no default export.</problem>
</dyad-problem-report><think>The file got corrupted with my instructions mixed into the code. I need to rewrite the entire FloatingCart.tsx file cleanly with the success popup. Let me provide the complete file.</think>The file got corrupted with my instructions mixed into the code. Let me rewrite it cleanly with the success popup and proper default export.

<dyad-write path="src/components/FloatingCart.tsx" description="Complete rewrite with success popup and default export">
"use client";
...
const FloatingCart = ({ quantities, setQuantities, equipment }: FloatingCartProps) => {
  ...
  useEffect(() => {
    ...
    catch { console.error("Nedá sa uložiť balíky do localStorage:", packageItems); }
  }, [packageItems]);
      ...
      try {
        ...
        if (data && Array.isArray(data)) {
          const mapped: CityMatch[] = data.map((item: any) => {
            ...
            return {
              name: item.display_name?.split(',')[0] || item.name || debouncedCitySearch,
              country: isCzech ? 'cz' : 'sk', lat: coords.lat, lng: coords.lng,
              postcode, district, distToNearest: nearest.distance, nearestPoint: nearest.name,
            };
          });
          const seen = new Set<string>();
  ...
  const cartItems = Object.entries(quantities)
    .filter(([_, qty]) => qty > 0)
    .map(([id, qty]) => { const item = equipment.find((e) => e.id === id); return { item, qty }; })
    .filter((entry): entry is { item: EquipmentItem; qty: number } => entry.item !== undefined);
  ...
  const buildCartSummaryHtml = () => {
    ...
    if (packageItems.length > 0) {
      html += '<h3 style="color:#BD20D3;font-size:16px;margin:20px 0 10px;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:8px;">📦 Balíky</h3>';
      packageItems.forEach((pkg) => {
        html += `<div style="background:rgba(189,32,211,0.05);border:1px solid rgba(189,32,211,0.2);border-radius:12px;padding:12px 16px;margin-bottom:10px;"><div style="display:flex;justify-content:space-between;align-items:center;"><strong style="color:white;font-size:14px;">${pkg.name}</strong><span style="color:#BD20D3;font-weight:700;font-size:14px;white-space:nowrap;margin-left:24px;">${getPackageTotal(pkg).toFixed(2)} €</span></div>`;
        if (pkg.hasLights) html += `<span style="display:inline-block;margin-top:6px;padding:3px 10px;background:rgba(189,32,211,0.1);border:1px solid rgba(189,32,211,0.3);border-radius:8px;color:#BD20D3;font-size:11px;font-weight:600;">💡 So svetlami</span>`;
        if (pkg.install === 'install') html += `<span style="display:inline-block;margin-top:6px;margin-left:6px;padding:3px 10px;background:rgba(26,75,255,0.1);border:1px solid rgba(26,75,255,0.3);border-radius:8px;color:#1A4BFF;font-size:11px;font-weight:600;">🔧 Inštalácia (+${pkg.installPrice} €)</span>`;
        if (pkg.install === 'install_uninstall') html += `<span style="display:inline-block;margin-top:6px;margin-left:6px;padding:3px 10px;background:rgba(26,75,255,0.1);border:1px solid rgba(26,75,255,0.3);border-radius:8px;color:#1A4BFF;font-size:11px;font-weight:600;">🔧 Inšt.+Deinšt. (+${pkg.installPrice} €)</span>`;
        if (pkg.arrival) html += `<span style="display:inline-block;margin-top:6px;margin-left:6px;padding:3px 10px;background:rgba(16,185,129,0.1);border:1px solid rgba(16,185,129,0.3);border-radius:8px;color:#10b981;font-size:11px;font-weight:600;">📍 ${pkg.arrival.name}${pkg.deliveryPrice > 0 ? ` (+${pkg.deliveryPrice} €)` : ' (Zdarma)'}</span>`;
        if (pkg.extras.length > 0) {
          html += '<div style="margin-top:8px;padding:8px 12px;background:rgba(0,0,0,0.2);border-radius:8px;font-size:12px;"><div style="color:#9ca3af;font-weight:600;margin-bottom:4px;">Doplnkové produkty:</div>';
          pkg.extras.forEach((e) => { html += `<div style="display:flex;justify-content:space-between;color:#d1d5db;padding:2px 0;"><span>${e.label} (${e.quantity}x)</span><span style="color:#BD20D3;margin-left:24px;">${(e.quantity * e.pricePerDay).toFixed(2)} €</span></div>`; });
          html += '</div>';
        }
        html += '</div>';
      });
    ...
    if (deliveryResult) {
      html += '<h3 style="color:#BD20D3;font-size:16px;margin:20px 0 10px;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:8px;">🚚 Doprava</h3>';
      html += `<div style="display:flex;justify-content:space-between;padding:6px 0;font-size:13px;"><span style="color:#9ca3af;">Doprava do <strong style="color:white;">${deliveryCity}</strong></span><span style="color:${deliveryResult.isFree ? '#10b981' : '#1A4BFF'};font-weight:700;margin-left:24px;white-space:nowrap;">${deliveryResult.isFree ? 'Zdarma' : `+${deliveryResult.price} €`}</span></div>`;
      if (!deliveryResult.isFree) html += `<div style="color:#6b7280;font-size:11px;padding-bottom:4px;">~${deliveryResult.distance} km od ${deliveryResult.nearestPoint}, 0,70 €/km</div>`;
    ...
    html += '<div style="margin-top:20px;padding-top:16px;border-top:2px solid #BD20D3;display:flex;justify-content:space-between;align-items:center;">';
    html += `<span style="color:white;font-size:18px;font-weight:700;">Celková suma</span>`;
    html += `<span style="color:#BD20D3;font-size:24px;font-weight:900;margin-left:24px;">${(grandTotal + packagesTotal).toFixed(2)} €</span></div>`;
    return html;
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const htmlContent = generateEmailHtml('rezervacia', {
        ...
        message: formData.message || '—',
        cartSummaryHtml, days, totalPrice: grandTotal + packagesTotal,
      });
    ...
    <>
        ...
        <div className="fixed bottom-8 right-8 z-[999] flex flex-col items-end" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
          {isHovered && !isOpen && (
            <div className="mb-4 w-80 bg-gradient-to-br from-[#0a0d1f]/95 to-[#020721]/95 border border-[#BD20D3]/40 rounded-2xl p-4 shadow-2xl backdrop-blur-md animate-in fade-in slide-in-from-bottom-2 duration-200">
              ...
              <button onClick={() => setIsOpen(true)} className="w-full mt-3 py-2 bg-[#BD20D3]/20 hover:bg-[#BD20D3]/30 border border-[#BD20D3]/40 text-white rounded-xl text-xs font-semibold transition-colors flex items-center justify-center gap-1"><span>Otvoriť rezerváciu</span><ChevronRight size={14} /></button>
            </div>
          )}
          <button onClick={() => setIsOpen(true)} className="relative flex items-center justify-center w-16 h-16 rounded-full btn-cyber shadow-[0_0_25px_rgba(189,32,211,0.5)] transition-transform duration-300 hover:scale-105 active:scale-95 group border-none">
            <ShoppingBag size={28} className="text-white group-hover:rotate-12 transition-transform" />
        ...
        <div className="fixed inset-0 z-[1000] flex items-start justify-center p-4 bg-black/85 backdrop-blur-md overflow-y-auto">
          <div className="w-full max-w-5xl my-4 md:my-8">
            <div className="bg-gradient-to-br from-[#0a0d1f] to-[#020721] border border-[#BD20D3]/40 rounded-3xl p-4 md:p-6 lg:p-8 relative shadow-2xl shadow-[#BD20D3]/20">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 lg:gap-8">
                <div className="lg:col-span-5 space-y-4">
                  <h3 className="text-base md:text-lg font-bold text-white flex items-center gap-2"><span>Vybraná technika</span><span className="text-sm bg-[#BD20D3]/20 border border-[#BD20D3]/40 text-[#BD20D3] px-3 py-1 rounded-full font-semibold">{totalItems} ks</span></h3>
                  <div className="space-y-3 max-h-[260px] overflow-y-auto pr-2 custom-scrollbar">
                    {cartItems.map(({ item, qty }) => {
                      const displayImg = item.main_image || (item.images && item.images[0]) || "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=100";
                      return (
                        <div key={item.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4">
                          <div className="flex items-center gap-3 w-full sm:w-auto">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg overflow-hidden border border-white/10 shrink-0 bg-black/40"><img src={displayImg} alt={item.name} className="w-full h-full object-cover" onError={(e) => { (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=100"; }} /></div>
                            <div className="flex-1 min-w-0"><h4 className="text-sm sm:text-base font-semibold text-white truncate">{item.name}</h4><p className="text-[#BD20D3] font-bold text-xs sm:text-sm mt-0.5 sm:mt-1">{item.price_per_day} € / deň</p></div>
                          </div>
                          <div className="flex items-center gap-2 bg-black/30 border border-white/10 rounded-lg p-1.5 ml-auto sm:ml-0">
                            <button type="button" onClick={() => handleQuantityChange(item.id, -1)} className="w-7 h-7 rounded-md hover:bg-white/10 flex items-center justify-center text-gray-400 hover:text-white transition-colors"><Minus size={12} /></button>
                            <span className="w-6 text-center text-white font-semibold text-sm">{qty}</span>
                      ...
                      <div className="border-t border-white/[0.06] pt-2 space-y-2">
                        <div className="relative" ref={cityRef}>
                          <div onClick={() => { if (packageHasDelivery) return; toggleDelivery(); }} className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${packageHasDelivery ? 'bg-gray-800/40 border-gray-700/50 opacity-50 cursor-not-allowed' : 'bg-black/20 border-white/5 hover:border-white/20'}`}>
                            ...
                            <MapPin size={14} className={`shrink-0 ${packageHasDelivery ? 'text-gray-600' : deliverySelected ? 'text-[#1A4BFF]' : 'text-gray-500'}`} />
                            <div className="flex-1 min-w-0">
                              {packageHasDelivery ? <span className="text-xs text-gray-500">Doprava (už v balíku)</span>
                              : <Input id="cart-city-input" type="text" value={deliveryCity} onChange={(e) => { setDeliveryCity(e.target.value); setDeliveryResult(null); setCityLocked(false); }} onKeyDown={handleCityKeyDown} onFocus={() => { if (deliveryCity.length >= 2 && deliverySelected && !cityLocked && citySuggestions.length > 0) setCityDropdownOpen(true); }} placeholder="Mesto odberu (SK/CZ)..." readOnly={!deliverySelected} className="bg-transparent border-0 text-white text-xs h-auto px-0 focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-gray-500" />}
                            </div>
                            <div className="shrink-0 min-w-[70px] text-right">
                              {packageHasDelivery ? <span className="text-xs text-gray-600">—</span> : deliverySelected && deliveryResult ? <span className={`text-xs font-bold ${deliveryResult.isFree ? 'text-emerald-400' : 'text-[#1A4BFF]'}`}>{deliveryResult.isFree ? 'Zdarma' : `+${deliveryResult.price} €`}</span> : <span className="text-xs text-gray-500">Vybrať</span>}
                          ...
                          {!packageHasDelivery && cityDropdownOpen && citySuggestions.length > 0 && deliverySelected && !cityLocked && (
                            <div className="absolute top-full left-0 right-0 mt-0.5 bg-[#0a0d1f] border border-white/[0.12] rounded-xl shadow-2xl shadow-black/50 overflow-hidden z-50 max-h-60 overflow-y-auto">
                              ...
                              {citySuggestions.map((city, i) => (
                                <button key={i} type="button" onClick={() => selectCity(city.name, city.lat, city.lng)} className="flex items-center gap-2.5 w-full p-2.5 transition-colors text-left border-b border-white/[0.06] last:border-b-0 hover:bg-[#1A4BFF]/5 cursor-pointer">
                                  <MapPin size={13} className="text-gray-500 shrink-0 self-start mt-0.5" />
                                  <div className="flex-1 min-w-0"><p className="text-xs text-white truncate">{city.name}</p><span className="text-[11px] text-gray-500/70 leading-tight block mt-0.5">{[city.postcode, city.district].filter(Boolean).join(', ')}</span></div>
                                  <div className="text-right shrink-0">
                                    <span className="text-[9px] text-gray-500 uppercase block">{city.country === 'sk' ? 'SK' : 'CZ'}</span>
                                    {city.distToNearest !== undefined && city.distToNearest > 0 && <span className="text-[10px] text-gray-600 mt-0.5 block whitespace-nowrap">~{city.distToNearest} km od {city.nearestPoint}</span>}
                                    {city.distToNearest !== undefined && city.distToNearest <= 0 && <span className="text-[10px] text-emerald-500/60 mt-0.5 block">v mieste odberu</span>}
                                  </div>
                                </button>
                              ))}
                            </div>
                  ...
                  <div className="border-t border-white/10 pt-4 space-y-2">
                    ...
                    {packageItems.length > 0 && (
                      <div className="border-t border-white/5 pt-3 space-y-2">
                        <p className="text-sm text-gray-400 font-bold uppercase">Balíky:</p>
                        {packageItems.map((pkg) => (<div key={pkg.id} className="flex justify-between text-base"><span className="text-gray-300 truncate flex-1 min-w-0 pr-4">{pkg.name}</span><span className="text-[#BD20D3] font-bold shrink-0">{getPackageTotal(pkg)} €</span></div>))}
                      </div>
                    )}
                    {(installSelected && !installUninstallSelected) && <div className="flex justify-between text-base text-gray-400"><span className="flex items-center gap-1.5"><Wrench size={14} className="text-[#1A4BFF]" /> Inštalácia</span><span className="text-[#1A4BFF] font-semibold">+{installCost + packageItems.filter(p => p.install === 'install').reduce((s, p) => s + p.installPrice, 0)} €</span></div>}
                    {(installUninstallSelected && !installSelected) && <div className="flex justify-between text-base text-gray-400"><span className="flex items-center gap-1.5"><Wrench size={14} className="text-[#1A4BFF]" /> Inštalácia a deinštalácia</span><span className="text-[#1A4BFF] font-semibold">+{installUninstallCost + packageItems.filter(p => p.install === 'install_uninstall').reduce((s, p) => s + p.installPrice, 0)} €</span></div>}
                    {!installSelected && !installUninstallSelected && packageInstallCount > 0 && <div className="flex justify-between text-base text-gray-400"><span className="flex items-center gap-1.5"><Wrench size={14} className="text-[#1A4BFF]" /> Inštalácia</span><span className="text-[#1A4BFF] font-semibold">+{packageItems.filter(p => p.install === 'install').reduce((s, p) => s + p.installPrice, 0)} €</span></div>}
                    {!installSelected && !installUninstallSelected && packageInstallUninstallCount > 0 && <div className="flex justify-between text-base text-gray-400"><span className="flex items-center gap-1.5"><Wrench size={14} className="text-[#1A4BFF]" /> Inštalácia a deinštalácia</span><span className="text-[#1A4BFF] font-semibold">+{packageItems.filter(p => p.install === 'install_uninstall').reduce((s, p) => s + p.installPrice, 0)} €</span></div>}
                    {deliverySelected && deliveryResult && <div className="flex justify-between text-base text-gray-400"><span className="flex items-center gap-1.5"><Truck size={14} className="text-emerald-400" /> Doprava ({deliveryCity})</span><span className={deliveryResult.isFree ? 'text-emerald-400 font-semibold' : 'text-[#1A4BFF] font-semibold'}>{deliveryResult.isFree ? 'Zdarma' : `+${deliveryResult.price} €`}</span></div>}
                    {packageItems.filter(p => p.arrival).map((pkg) => (<div key={pkg.id} className="flex justify-between text-base text-gray-400"><span className="flex items-center gap-1.5"><Truck size={14} className="text-emerald-400" /> Doprava ({pkg.arrival?.name})</span><span className={pkg.deliveryPrice > 0 ? 'text-[#1A4BFF] font-semibold' : 'text-emerald-400 font-semibold'}>{pkg.deliveryPrice > 0 ? `+${pkg.deliveryPrice} €` : 'Zdarma'}</span></div>))}
                    <div className="border-t border-white/5 pt-4 flex justify-between items-end">
                      <span className="text-white font-bold text-lg">Celková suma</span>
                      <span className="text-[#BD20D3] font-extrabold text-3xl">{(grandTotal + packagesTotal).toFixed(2)} €</span>
                    </div>
                ...
                <div className="lg:col-span-7 bg-black/20 border border-white/10 rounded-2xl p-4 md:p-6 lg:p-8">
                  <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                      <div className="space-y-1.5"><Label htmlFor="firstName" className="text-gray-300 flex items-center gap-1.5 text-sm"><User size={14} className="text-[#BD20D3]" /> Meno *</Label><Input id="firstName" type="text" placeholder="Ján" value={formData.firstName} onChange={(e) => setFormData(prev => ({ ...prev, firstName: e.target.value }))} className="bg-black/50 border-white/10 text-white rounded-xl h-10 md:h-11" required /></div>
                      <div className="space-y-1.5"><Label htmlFor="lastName" className="text-gray-300 flex items-center gap-1.5 text-sm"><User size={14} className="text-[#BD20D3]" /> Priezvisko *</Label><Input id="lastName" type="text" placeholder="Novák" value={formData.lastName} onChange={(e) => setFormData(prev => ({ ...prev, lastName: e.target.value }))} className="bg-black/50 border-white/10 text-white rounded-xl h-10 md:h-11" required /></div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                      <div className="space-y-1.5"><Label htmlFor="email" className="text-gray-300 flex items-center gap-1.5 text-sm"><Mail size={14} className="text-[#BD20D3]" /> Email *</Label><Input id="email" type="email" placeholder="jan@priklad.sk" value={formData.email} onChange={(e) => setFormData(prev => ({ ...prev, email: e.target.value }))} className="bg-black/50 border-white/10 text-white rounded-xl h-10 md:h-11" required /></div>
                      <div className="space-y-1.5"><Label htmlFor="phone" className="text-gray-300 flex items-center gap-1.5 text-sm"><Phone size={14} className="text-[#BD20D3]" /> Telefón</Label><Input id="phone" type="tel" placeholder="+421 900 123 456" value={formData.phone} onChange={(e) => setFormData(prev => ({ ...prev, phone: e.target.value }))} className="bg-black/50 border-white/10 text-white rounded-xl h-10 md:h-11" /></div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                      <div className="space-y-1.5 relative" ref={fromRef}>
                        ...
                        {showFromCalendar && (<div className="absolute top-full left-0 mt-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200 rounded-xl"><DayPicker mode="single" selected={formData.dateFrom ? new Date(formData.dateFrom) : undefined} onSelect={handleFromSelect} disabled={[{ before: startOfDay(new Date()) }]} weekStartsOn={1} initialFocus={showFromCalendar} /></div>)}
                      </div>
                      <div className="space-y-1.5 relative" ref={toRef}>
                        ...
                        {showToCalendar && (<div className="absolute top-full left-0 mt-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200 rounded-xl"><DayPicker mode="single" selected={formData.dateTo ? new Date(formData.dateTo) : undefined} onSelect={handleToSelect} disabled={[{ before: formData.dateFrom ? addDays(new Date(formData.dateFrom), 1) : startOfDay(new Date()) }]} weekStartsOn={1} initialFocus={showToCalendar} /></div>)}
                      </div>
                    </div>
                    <div className="space-y-1.5"><Label htmlFor="message" className="text-gray-300 flex items-center gap-1.5 text-sm"><MessageSquare size={14} className="text-[#BD20D3]" /> Poznámka k objednávke</Label><Textarea id="message" placeholder="Napíšte nám podrobnosti..." value={formData.message} onChange={(e) => setFormData(prev => ({ ...prev, message: e.target.value }))} className="bg-black/50 border-white/10 text-white rounded-xl min-h-[60px] md:min-h-[80px]" /></div>
      ...
      <Dialog open={showReservationSuccess} onOpenChange={setShowReservationSuccess}>
        <DialogContent className="bg-[#0a0d1f] border border-[#BD20D3]/40 text-white max-w-md rounded-3xl shadow-2xl shadow-[#BD20D3]/20 p-8 text-center">
          ...
          <Button onClick={() => setShowReservationSuccess(false)} className="btn-cyber border-none rounded-xl h-12 px-8 font-bold mt-6 w-full">
            Zavrieť
          </Button>
        </DialogContent>
      </Dialog>
