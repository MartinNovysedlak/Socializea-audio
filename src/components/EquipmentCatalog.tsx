...
const imageMap: Record<string, string> = {
  ...
  '8ad9b8347562783<dyad-writepath="src/components/EquipmentCatalog.tsx" description="Complete rewrite of EquipmentCatalog with proper default export and fixed syntax">
"use client";
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
              <div>
                ...
                <p className="text-gray-400">
                  Vyberte si jednotlivé položky a pridajte ich do kalkulačky                </p>
              </div>
