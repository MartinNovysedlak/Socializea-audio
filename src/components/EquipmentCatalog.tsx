...
const equipmentData: EquipmentItem[] = [
  // Sound
  { id: 'mixer-x1222', name: 'Mixážny pult Behringer Xenyx X1222 USB', category: 'sound', pricePerDay: 25, available: 1, image: `/Prenajom/${imageMap['BEXENYXX1222USB-03.jpg']}` },
  { id: 'mixer-802', name: 'Mixážny pult Behringer Xenyx 802', category: 'sound', pricePerDay: 15, available: 1, image: `/Prenajom/${imageMap['8ad9b834756278363ba501b7aedf9399bc1ad25a_original.jpeg']}` },
  { id: 'mic-set', name: 'Sada 2 mikrofónov the t.bone free solo Twin HT', category: 'sound', pricePerDay: 20, available: 1, image: `/Prenajom/${imageMap['da62e99f-837c-48ec-bb5f-94b01a8c2d0b.jpg']}` },
  { id: 'mic-auna', name: 'Mikrofony a headsety Auna VHF', category: 'sound', pricePerDay: 10, available: 4, image: `/Prenajom/${imageMap['10034470_yy_0001_titel___auna_UHF200C_2B.jpg']}` },
  { id: 'speakers-b112d', name: 'Reproduktory Behringer b112d', category: 'sound', pricePerDay: 15, available: 4, image: `/Prenajom/${imageMap['Behringer_B112D_Package.jpg']}` },
  { id: 'speaker-b208d', name: 'Reproduktor Behringer b208d', category: 'sound', pricePerDay: 12, available: 1, image: `/Prenajom/${imageMap['61UhrM+sGkL.jpg']}` },
  { id: 'sub-b1500xp', name: 'Subwoofery Behriger B1500XP', category: 'sound', pricePerDay: 30, available: 2, image: `/Prenajom/${imageMap['387288.jpg']}` },
  { id: 'sub-dsp18', name: 'Subwoofer The Box Pro DSP 18 Sub', category: 'sound', pricePerDay: 35, available: 5, image: `/Prenajom/${imageMap['717kj+PEWhL._AC_UF1000,1000_QL80_.jpg']}` },

  // Lighting
  { id: 'dmx-pult', name: 'Riadiaci DMX pult Light4Me DMX 192', category: 'lighting', pricePerDay: 20, available: 1, image: `/Prenajom/${imageMap['887ed9_d483db86d97b4f21b9e472b145e6d3a7~mv2.webp']}` },
  { id: 'led-par', name: 'RGBWA UV Led Par svetlá', category: 'lighting', pricePerDay: 8, available: 8, image: `/Prenajom/${imageMap['12-12w-12-18w-Led-Par-Light-RGBW-RGBWA-UV-4in1-6in1-Flat-Par-Light-DMX512.jpg']}` },
  ...
  { id: 'tripod', name: 'Trojnožka na reproduktory', category: 'other', pricePerDay: 10, available: 2, image: `/Prenajom/${imageMap['small_bespeco-pn90xlno-teleskopicky-repro-stoj.jpg']}` },
  { id: 'speaker-mount', name: 'Držiak pre dvojicu reproboxov', category: 'other', pricePerDay: 5, available: 2, image: `/Prenajom/${imageMap['small_bose-sub1-sub2-adjustable-speaker-pole.jpg']}` },
  { id: 'telescopic', name: 'Teleskopická stojanová tyč', category: 'other', pricePerDay: 8, available: 2, image: `/Prenajom/${imageMap['stojan-na-mikrofon-182cm.jpg']}` },
  { id: 'bubble', name: 'Bublinkostroj', category: 'other', pricePerDay: 20, available: 2, image: `/Prenajom/${imageMap['adj_bubbletron_thedjshop.jpg']}` },
  { id: 'party-bar', name: 'Svetlá BeamZ Party Bar', category: 'other', pricePerDay: 20, available: 1, image: `/Prenajom/${imageMap['beamz-party-bar.jpg']}` },
  { id: 'strobe', name: 'Stroboskop', category: 'other', pricePerDay: 15, available: 1, image: `/Prenajom/${imageMap['14406264_800.jpg']}` },
  { id: 'fire', name: 'Výrobníky plameňov Fire Machine', category: 'other', pricePerDay: 30, available: 2, image: `/Prenajom/${imageMap['18648447_800.jpg']}` },
];
