      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-[#020721] via-[#0a0d1f] to-[#020721] border border-[#BD20D3]/20 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 backdrop-blur-xl overflow-hidden relative">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row-reverse items-center gap-8 md:gap-12">
              <div className="w-full lg:w-2/5 grid grid-cols-2 gap-3 md:gap-4">
                <div className="space-y-3 md:space-y-4">
                  <div className="aspect-square rounded-xl md:rounded-2xl bg-gradient-to-br from-[#BD20D3]/20 to-transparent border border-white/10 flex flex-col items-center justify-center text-center p-3 md:p-4">
                    <Music className="text-[#BD20D3] mb-2" size={24} />
                    <span className="text-[10px] md:text-xs font-bold text-white uppercase">Svadby</span>
                  </div>
                  <div className="aspect-square rounded-xl md:rounded-2xl bg-gradient-to-br from-[#1A4BFF]/20 to-transparent border border-white/10 flex flex-col items-center justify-center text-center p-3 md:p-4">
                    <Mic2 className="text-[#1A4BFF] mb-2" size={24} />
                    <span className="text-[10px] md:text-xs font-bold text-white uppercase">Eventy</span>
                  </div>
                </div>
                <div className="space-y-3 md:space-y-4 pt-4 md:pt-8">
                  <div className="aspect-square rounded-xl md:rounded-2xl bg-white/5 border border-white/10 flex flex-col items-center justify-center text-center p-3 md:p-4">
                    <Disc className="text-gray-400 mb-2" size={24} />
                    <span className="text-[10px] md:text-xs font-bold text-white uppercase">Párty</span>
                  </div>
                  <div className="aspect-square rounded-xl md:rounded-2xl bg-gradient-to-br from-[#BD20D3]/20 to-transparent border border-white/10 flex flex-col items-center justify-center text-center p-3 md:p-4">
                    <Zap className="text-[#BD20D3] mb-2" size={24} />
                    <span className="text-[10px] md:text-xs font-bold text-white uppercase">Oslavy</span>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full lg:w-3/5 space-y-6 md:space-y-8">
                <div className="flex items-center gap-3 text-[#BD20D3]">
                  <Headphones size={20} />
                  <span className="font-bold uppercase tracking-widest text-[10px] md:text-sm">Profesionálny hudobný doprovod v Kysuckom regióne</span>
                </div>
                ...
                <div className="flex flex-wrap gap-3 md:gap-4">
                  <Button className="btn-cyber h-11 md:h-14 px-6 md:px-10 rounded-xl md:rounded-xl text-sm md:text-lg border-none">
                    Kontaktujte nás
                  </Button>
                  <div className="flex items-center gap-3 md:gap-4 px-4 md:px-6 py-3 rounded-xl bg-white/5 border border-white/10 text-white font-medium text-xs md:text-sm">
                    <Disc className="animate-spin-slow text-[#BD20D3]" size={16} />
                    Všetky žánre
                  </div>
                </div>
              </div>
