      ...
      <DialogPortal>
        <DialogContent className="bg-[#0a0d1f] border-white/10 text-white max-w-3xl rounded-3xl overflow-hidden shadow-2xl shadow-[#BD20D3]/20 p-0 z-[9999]">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-3 right-3 z-[9999] pointer-events-auto bg-[#0a0d1f]/90 backdrop-blur-sm border border-white/10 rounded-xl p-2.5 shadow-lg max-w-[160px]">
