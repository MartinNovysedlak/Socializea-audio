            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-8 sm:gap-16">
                ...
                <ul className="space-y-3 sm:space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-gray-300 text-sm sm:text-base">
                      <CheckCircle2 className="text-[#1A4BFF] shrink-0" size={20} />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>

                <Link to="/predaj" className="inline-block w-full sm:w-auto">
                  <Button className="btn-cyber h-11 sm:h-14 px-6 sm:px-8 rounded-xl text-base sm:text-lg group border-none w-full sm:w-auto">
                    <ShoppingBag className="mr-2 w-4 h-4 sm:w-5 sm:h-5 shrink-0" />
              ...
              <div className="w-full lg:w-1/2">
                <div className="grid grid-cols-12 gap-3 sm:gap-4">
                  <div className="col-span-7 rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                    <img 
                  ...
                  <div className="col-span-5 space-y-3 sm:space-y-4">
                    <div className="aspect-square rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                      <img 
                    ...
                    <div className="aspect-square rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#1A4BFF] to-[#BD20D3] p-4 sm:p-6 flex items-center justify-center text-center">
